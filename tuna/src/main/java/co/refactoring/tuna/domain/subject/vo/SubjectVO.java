...
import co.refactoring.tuna.domain.common.vo.subject.LectureScheduleVO;
import co.refactoring.tuna.domain.objection.vo.ObjectionVO;
import co.refactoring.tuna.domain.task.vo.TaskVO;
